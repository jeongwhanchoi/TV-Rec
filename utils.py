...
def parse_args():
    ...
    # model args
    parser.add_argument("--model_type", default='TVRec', type=str)
    ...
    parser.add_argument("--dt_min", default=0.0, type=float)
    parser.add_argument("--dt_max", default=0.5, type=float)
